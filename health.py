...
def take(k):
    ...
    if k==1:
        ...
        print("plz enter valid input (1(harshit),2(rohan),3(hammad)")
...
def retrieve(k):
    ...
    if k==1:
        ...
        print("plz enter valid input (harshit,rohan,hammad)")
...
if a==1:
    ...
    b = int(input("press 1 for harshit 2 for rohan 3 for hammad "))
